...
class AddonsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Notes by Hend: Moved this to AddonsActivity instead of Application class.
        // Both objects are singleton however I would have preferred if there is way to not call
        // this again once they are not null instead of moving them back to Application class
